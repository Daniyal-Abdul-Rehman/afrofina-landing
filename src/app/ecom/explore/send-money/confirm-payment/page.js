...
import { SidebarSendMoney, Stepper, ConfirmPayment, Processing, PaymentFailed, Congratulation } from '@/components/organisms'
                ...
                <SidebarSendMoney /> <div className='flex justify-center w-full h-full overflow-auto px-4'>
                    <div className='lg:w-1/2 w-full pt-10'>
                        <div className='lg:block hidden'>
                            <Stepper steppers={steppers} current={'Recipient details'} currentIndex={3} />
                        </div>
