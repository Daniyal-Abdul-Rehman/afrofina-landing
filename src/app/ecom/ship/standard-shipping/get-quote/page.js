            ...
            <div className='h-full flex'>
                ...
                <div className='w-full h-full overflow-auto'>
                    ...
                    <div className='lg:px-14 px-4'>
                        ...
                        <Text className="!text-[24px] text-black sf-pro py-3 !font-medium lg:pt-14 pt-8" align="left">
                            Weight
                        </Text>
                        <div className='grid lg:grid-cols-2 grid-cols-1 gap-8'>
                            <Select className="pr-3" placeholderValue="0" />
                        </div>
                        <div className='flex justify-center pt-12 pb-8'>
                            <Link href={'/ecom/ship/standard-shipping/delivery-options-quote'} className=' lg:w-auto w-full'>
