...
export default function PageOrgSix({refRoyal}) {
    return (
        <div ref={refRoyal} className='grid lg:grid-cols-2 grid-cols-1 lg:gap-5 gap-0 pt-12 lg:p-5 p-0 animate-slide-in'>
