...
import { Text, Button, Input, Image } from '@/components/atoms'
export default function HospitalAmountForm() {
    return (
        <div className='space-y-6 pb-24'>
            <div className='space-y-2 pb-5 pt-16'>
                <Text variant="h5" className="text-black font-media-sans-semicondensed custom-font lg:block hidden">
                Amount 
                </Text>
                <Text>
